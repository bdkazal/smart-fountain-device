...
void startMonitorTaskIfNeeded()
{
  if (monitorTaskStarted)
  {
    return;
  }

  monitorTaskStarted = true;

  xTaskCreatePinnedToCore(
      wifiResetMonitorTask,
      "wifi-reset",
      3072,
      nullptr,
      1,
